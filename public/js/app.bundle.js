...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_zoomImage__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__actions__ = __webpack_require__(4);
...
const store = Object(__WEBPACK_IMPORTED_MODULE_2__state__["a" /* generateStore */])(__WEBPACK_IMPORTED_MODULE_1__config__["b" /* initialState */]);
//Allow the zoomImage render method to be notified of state changes
store.subscribe(__WEBPACK_IMPORTED_MODULE_0__components_zoomImage__["b" /* render */]);
//Get the current viewport dimensions and update the state with values
store.updateState(Object(__WEBPACK_IMPORTED_MODULE_4__actions__["d" /* saveViewportDimensions */])(Object(__WEBPACK_IMPORTED_MODULE_3__utils__["a" /* determineViewport */])()));
//Call zoomImage's initialRender fn which in addition to rendering also binds the components events
Object(__WEBPACK_IMPORTED_MODULE_0__components_zoomImage__["a" /* initialRender */])(store);
...
/* unused harmony export isInsideBox */
/* unused harmony export isEdgeOfImage */
/* harmony export (immutable) */ __webpack_exports__["b"] = render;
/* harmony export (immutable) */ __webpack_exports__["a"] = initialRender;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actions__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_morphdom__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_morphdom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_morphdom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils__ = __webpack_require__(6);
    ...
    if(!state.zoomed) {
        return `<div id="zoom-component">
                    ...
                    <div class="images-container" style="width:${state.dimensions.width}px; height:${state.dimensions.width}px">
                        <img class="zoom-image" src="${Object(__WEBPACK_IMPORTED_MODULE_3__utils__["b" /* generateZoomImageRoute */])(state)}" style="width:${state.dimensions.width}px; height:${state.dimensions.width}px; transform: matrix(1, 0, 0, 1, ${state.zoomPos.x}, ${state.zoomPos.y});"/>
                    </div>
                </div>`
    } else {
        return `<div id="zoom-component">
                    ...
                    <div class="images-container zoomed" style="width:${state.dimensions.width}px; height:${state.dimensions.width}px">
                        <img class="zoom-image zoomed" src="${Object(__WEBPACK_IMPORTED_MODULE_3__utils__["b" /* generateZoomImageRoute */])(state)}" style="width:${state.dimensions.width}px; height:${state.dimensions.width}px; transform: matrix(3, 0, 0, 3, ${state.zoomPos.x}, ${state.zoomPos.y});"/>
                    </div>
                </div>`
    }
}
    ...
    document.querySelector('.zoom-image').addEventListener('touchstart', (e) => {
        ...
        function touchMovement(e) {
            ...
            if( store.getState().zoomed && isInsideBox(e, containerPos) && isEdgeOfImage(xDiff, yDiff, store.getState())) {
                ...
                store.updateState(Object(__WEBPACK_IMPORTED_MODULE_1__actions__["e" /* updateZoomPosition */])(xDiff, yDiff));
            }
        }
        ...
        function zoomOrDrag(e) {
            if(e.changedTouches[0].pageX === pageX && e.changedTouches[0].pageY === pageY) {
                store.updateState(Object(__WEBPACK_IMPORTED_MODULE_1__actions__["f" /* zoomImage */])());
            }
 ...
 */
function isInsideBox(e, containerPos) {
 ...
 */
function isEdgeOfImage(xDiff, yDiff, state) {
...
function render(state) {
    __WEBPACK_IMPORTED_MODULE_2_morphdom___default()(document.querySelector(domLocation), template(state).trim());
}
...
"use strict";
/* unused harmony export updateDimensions */
/* unused harmony export updateZoomed */
/* unused harmony export updateZoomPosition */
 ...
 */
function updateDimensions(state, update) {
    if(update.type === __WEBPACK_IMPORTED_MODULE_0__actions__["a" /* SAVE_VIEWPORT_DIMENSIONS */]) {
        return Object.assign({}, state, {
            width: Math.min(update.payload.width, __WEBPACK_IMPORTED_MODULE_1__config__["a" /* defaults */].maxImageWidth)
        });
    }
 ...
 * @param {object} update - The update flowing through the store
 */
function updateZoomed(state, update) {
    if(update.type === __WEBPACK_IMPORTED_MODULE_0__actions__["c" /* ZOOM_IMAGE */]) {
        return !state;
    }
 ...
 * @param {object} update - The update flowing through the store
 */
function updateZoomPosition(state, update) {
    if(update.type === __WEBPACK_IMPORTED_MODULE_0__actions__["c" /* ZOOM_IMAGE */]) {
    ...
    if(update.type === __WEBPACK_IMPORTED_MODULE_0__actions__["b" /* UPDATE_ZOOM_POSITION */]) {
        return Object.assign({}, {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["d"] = saveViewportDimensions;
/* harmony export (immutable) */ __webpack_exports__["f"] = zoomImage;
/* harmony export (immutable) */ __webpack_exports__["e"] = updateZoomPosition;
const SAVE_VIEWPORT_DIMENSIONS = 'SAVE_VIEWPORT_DIMENSIONS';
/* harmony export (immutable) */ __webpack_exports__["a"] = SAVE_VIEWPORT_DIMENSIONS;

const ZOOM_IMAGE = 'ZOOM_IMAGE';
/* harmony export (immutable) */ __webpack_exports__["c"] = ZOOM_IMAGE;

const UPDATE_ZOOM_POSITION = 'UPDATE_ZOOM_POSITION';
/* harmony export (immutable) */ __webpack_exports__["b"] = UPDATE_ZOOM_POSITION;
 ...
 */
function saveViewportDimensions({width, height}) {
    return {
 ...
 */
function updateZoomPosition(x, y) {
    return {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = determineViewport;
/* harmony export (immutable) */ __webpack_exports__["b"] = generateZoomImageRoute;
/**
 ...
 */
function generateZoomImageRoute({dimensions, images}) {
    return `${images.product}?w=${dimensions.width*3}`;
}

/***/ })
/******/ ]);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,