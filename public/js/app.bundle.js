...
Object(__WEBPACK_IMPORTED_MODULE_3__utils__["a" /* determineViewport */])(store.updateState);
...
function updateZoomPosition(x, y, offsetX, offsetY) {
    return {
...
/* unused harmony export generateImageRoute */
/* harmony export (immutable) */ __webpack_exports__["b"] = generateZoomImageRoute;
/* unused harmony export getImageCenter */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actions__ = __webpack_require__(4);


function determineViewport(updateState) {
    updateState(Object(__WEBPACK_IMPORTED_MODULE_0__actions__["d" /* saveViewportDimensions */])(window.innerWidth, window.innerHeight));
}

function generateImageRoute({dimensions, routes}) {
    return `${routes.images}?w=${dimensions.width}`;
}

function generateZoomImageRoute({dimensions, routes}) {
    return `${routes.images}?w=${dimensions.width*3}`;
}

function getImageCenter({dimensions}) {
